...
def loading_postprocess():
  ...
  # pyinterpreter
  from PyInterpreter.PyInterpreter import PyInterpreter
  global gPyInterpreter
  gPyInterpreter = PyInterpreter.instance()
  
  # resource viewer
  from ResourceMgr.ResourceMgr import ResourceViewer
  global gResViewer
...
class MyRoot(App, Singleton):
  ...
  def getClipboard(self, mimetype='text/plain'):
    ...
    try:
      ...
      ClipDescription = autoclass and autoclass('android.content.ClipDescription')
